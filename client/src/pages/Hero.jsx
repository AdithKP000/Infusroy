        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_500px] lg:gap-16 xl:grid-cols-[1fr_600px] items-center">
          <div className="flex flex-col justify-center space-y-8 animate-in slide-in-from-left duration-1000">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl font-black tracking-tight sm:text-5xl xl:text-6xl/tight">
                <span className="block text-slate-900 mb-2 font-bold font-[Montserrat]">Transform Your</span>
                <span className="block bg-black bg-clip-text text-transparent mb-2 font-bold font-[Montserrat]  "  >
                  3D Models
                </span>
                <span className="block text-slate-900 font-bold font-[Montserrat] ">
                  with{" "}
                  <span className="relative inline-block">
                    <span className="text-blue-400 bg-clip-text  ">
                      INFUSORY
                    </span>
                    <div className="absolute -bottom-2 left-0 right-0 h-1  rounded-full"></div>
                  </span>
                </span>
              </h1>

              <p className="max-w-[600px] text-slate-600 text-lg md:text-xl leading-relaxed">
                Upload, visualize, and experience your 3D models 
              </p>
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
              <button
                ...
                className="group relative inline-flex items-center justify-center h-14 px-8 rounded-2xl  text-black font-semibold border border-slate-300 hover:border-blue-400  bo transition-all duration-300 transform hover:scale-105 hover:shadow-2xl overflow-hidden"
              >
                ...
                <div className="absolute inset-0 rounded-2xl  opacity-0 group-hover:opacity-20 blur-xl transition-opacity duration-300"></div>
              </button>
              <button
